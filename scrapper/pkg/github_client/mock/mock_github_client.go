...
// Source: /home/anton/tbank-tech/scrapper/pkg/github/github-client.go
...
func (m *MockGitHubClient) LatestCommit(ctx context.Context, owner, repo string, opts *github.CommitsListOptions) (*github.RepositoryCommit, *github.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LatestCommit", ctx, owner, repo, opts)
...
func (mr *MockGitHubClientMockRecorder) LatestCommit(ctx, owner, repo, opts interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LatestCommit", reflect.TypeOf((*MockGitHubClient)(nil).LatestCommit), ctx, owner, repo, opts)
}
