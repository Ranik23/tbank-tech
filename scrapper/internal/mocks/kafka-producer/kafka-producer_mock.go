...
// Source: /home/anton/go/pkg/mod/github.com/!i!b!m/sarama@v1.45.1/async_producer.go

// Package kafkaproduce is a generated GoMock package.
...
func (mr *MockAsyncProducerMockRecorder) AddMessageToTxn(msg, groupId, metadata interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddMessageToTxn", reflect.TypeOf((*MockAsyncProducer)(nil).AddMessageToTxn), msg, groupId, metadata)
}
...
func (mr *MockAsyncProducerMockRecorder) AddOffsetsToTxn(offsets, groupId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddOffsetsToTxn", reflect.TypeOf((*MockAsyncProducer)(nil).AddOffsetsToTxn), offsets, groupId)
}
